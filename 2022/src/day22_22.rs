...
pub fn run(real: bool, print_result: bool) -> (u128, u128, u128) {
    ...
    let next_pos = | cp: (i64,i64), cd: i64, field: &HashMap<(i64,i64),bool>, part: usize | -> ((i64,i64), i64) {
    ...
    let run = | initial_pos: (i64,i64), initial_dir: i64, part: usize | -> i64 {
