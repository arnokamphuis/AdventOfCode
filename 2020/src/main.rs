...
fn main() {
    let days: Vec<(&str, fn(bool, bool) -> (u128, u128, u128), usize)> = vec![
        ("Day 01 of 2020", day01_20::run, 50),
        ("Day 02 of 2020", day02_20::run, 50),
        ("Day 03 of 2020", day03_20::run, 50),
        ("Day 04 of 2020", day04_20::run, 50),
        ("Day 05 of 2020", day05_20::run, 50),
        ("Day 06 of 2020", day06_20::run, 50),
        ("Day 07 of 2020", day07_20::run, 50),
        ("Day 08 of 2020", day08_20::run, 50),
        ("Day 09 of 2020", day09_20::run, 50),
        ("Day 10 of 2020", day10_20::run, 50),
        ("Day 11 of 2020", day11_20::run, 10),
        ("Day 12 of 2020", day12_20::run, 50),
        ("Day 13 of 2020", day13_20::run, 50),
        ("Day 14 of 2020", day14_20::run, 10),
        ("Day 15 of 2020", day15_20::run, 10),
        ("Day 16 of 2020", day16_20::run, 50),
        ("Day 17 of 2020", day17_20::run, 10),
        ("Day 18 of 2020", day18_20::run, 50),
        ("Day 19 of 2020", day19_20::run, 10),
        ("Day 20 of 2020", day20_20::run, 50),
        ("Day 21 of 2020", day21_20::run, 50),
        ("Day 22 of 2020", day22_20::run, 50),
        ("Day 23 of 2020", day23_20::run, 50),
